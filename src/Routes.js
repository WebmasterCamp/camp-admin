  ...
  <StyledLayout>
    <Sider trigger={null} collapsible collapsed={false}>
      ...
      <Menu theme="dark" mode="inline">
        ...
        {['design', 'marketing', 'programming', 'content'].indexOf(
          props.user.role,
        ) !== -1 && (
          <Menu.Item key="Interviewer">
            <Link to="/interviewer">
              <Icon type="user" />
    ...
    <Layout>
      ...
      >
        ...
        <AdminRoute
          ...
          exact
          component={InteviewCandidate}
        />
        {props.user.role === 'admin' && (
          <AdminRoute user={props.user} path="/slips" exact component={Slip} />
        )}
        {props.user.role === 'slips' && (
          <SlipRoute user={props.user} path="/slips" exact component={Slip} />
        )}
        <AdminRoute
          user={props.user}
          path="/finalists"
        ...
        {(props.user.role === 'marketing' ||
          props.user.role === 'content' ||
          props.user.role === 'programming' ||
          props.user.role === 'design') && (
          <MajorRoute
            user={props.user}
            path="/grading"
            exact
